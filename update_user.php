...
if(isset($_POST['submit'])){
   ...
   $name = $_POST['name'];
   $name = filter_var($name, FILTER_SANITIZE_STRING); // this fun() is used to check whether the email is correct or not 
   $email = $_POST['email'];
   ...
   $empty_pass = 'da39a3ee5e6b4b0d3255bfef95601890afd80709'; // this is a hashed code of empty string 
